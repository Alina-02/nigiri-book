...
const FavouriteBookShelf = () => {
  const [selected, setSelected] = useState(sortOptions[1]);

  const { getFavoriteBooks } = useMainStore();
  const shelfBooks = getFavoriteBooks();
...
export default FavouriteBookShelf;
