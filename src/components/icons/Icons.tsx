  ...
  star: (props: SVGProps<SVGSVGElement>) => (
    ...
    >
      <path
        fill="#fff"
        stroke="#AE8003"
        d="M16.001.5c.177 0 .35.05.502.146a.971.971 0 0 1 .354.397l4.154 8.535.116.237.26.039 9.293 1.367a.947.947 0 0 1 .456.2.974.974 0 0 1 .298.41.997.997 0 0 1-.147.97l-.087.095-6.724 6.637-.186.183.043.257 1.589 9.383a.977.977 0 0 1-.34.927.949.949 0 0 1-.83.189l-.12-.04-.115-.054-8.272-4.42-.235-.125-.236.125-8.31 4.43a.941.941 0 0 1-.96-.043.97.97 0 0 1-.437-.75v-.13l.012-.109 1.587-9.383.044-.257-.186-.183L.793 12.89v-.001a.996.996 0 0 1-.012-1.395.953.953 0 0 1 .425-.25l.129-.027 9.276-1.363.262-.039.115-.237 4.156-8.535a.972.972 0 0 1 .354-.397.944.944 0 0 1 .503-.146Z"
      />
    </svg>
  ),
